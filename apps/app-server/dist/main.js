...
const $7efce5ff8f6cead1$export$776ed06f580210d5 = ({ app: app  })=>{
    app.post("/api/gc-tts/list-voices", $294ee9ecf07720ae$export$2272521fb3bd5353);
    app.post("/api/gc-tts/synthesize-speech", $294ee9ecf07720ae$export$720e715da265c262);
};
