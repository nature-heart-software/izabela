...
const $9ea4c5e7d90b028e$export$d3da1ecaf1206c58 = (
  res,
  reason,
  message,
  code,
...
const $54aaeaab856c6181$export$2272521fb3bd5353 = async (
  {
    body: {
  ...
  try {
    const {
      data: { voices: voices },
    } = await $parcel$interopDefault($1hSWc$axios).get(
      `https://texttospeech.googleapis.com/v1beta1/voices?key=${apiKey}`,
    )
    res.status(200).json(voices)
  } catch (e) {
    $9ea4c5e7d90b028e$export$d3da1ecaf1206c58(
      res,
...
const $54aaeaab856c6181$export$720e715da265c262 = async (
  {
    body: {
      credentials: { apiKey: apiKey },
      payload: payload,
  ...
  const outputFile = $1hSWc$path.join(
    $a3bdc0234368055c$export$2e2bcd8739ae039.getConfig().tempPath,
    $1hSWc$uuid.v4() + '.mp3',
  )
  try {
    $1hSWc$fs.mkdirSync(
      $1hSWc$path.parse(outputFile).dir,
      {
        recursive: true,
      },
      (err) => {
    ...
    } = await $parcel$interopDefault($1hSWc$axios).post(
...
const $5e8fcb11fef7f285$export$776ed06f580210d5 = ({ app: app }) => {
  app.post(
    ...
    $54aaeaab856c6181$export$2272521fb3bd5353,
  )
  app.post(
    '/api/tts/google-cloud/synthesize-speech',
    $54aaeaab856c6181$export$720e715da265c262,
  )
}

const $151961d6168f89a5$export$2272521fb3bd5353 = async (
  {
    body: {
      credentials: { apiKey: apiKey, region: region },
    },
  },
  res,
) => {
  try {
    ...
    const { data: voices } = await $parcel$interopDefault($1hSWc$axios).get(
      endpoint,
      {
        headers: {
...
const $151961d6168f89a5$export$720e715da265c262 = async (
  {
    body: {
      credentials: { apiKey: apiKey, region: region },
  ...
  try {
    ...
    $1hSWc$fs.writeFileSync(outputFile, '')
    const speechConfig =
      $1hSWc$microsoftcognitiveservicesspeechsdk.SpeechConfig.fromSubscription(
        apiKey,
        region,
      )
    ...
    speechConfig.speechSynthesisOutputFormat =
      $1hSWc$microsoftcognitiveservicesspeechsdk.SpeechSynthesisOutputFormat.Audio24Khz160KBitRateMonoMp3
    const audioConfig =
      $1hSWc$microsoftcognitiveservicesspeechsdk.AudioConfig.fromAudioFileOutput(
        outputFile,
      )
    const synthesizer =
      new $1hSWc$microsoftcognitiveservicesspeechsdk.SpeechSynthesizer(
        speechConfig,
        audioConfig,
      )
...
const $2e5d6a656809d93c$export$a93cd00e7c1effd6 = ({ app: app }) => {
  app.post(
    '/api/tts/microsoft-azure/list-voices',
    $151961d6168f89a5$export$2272521fb3bd5353,
  )
  app.post(
    '/api/tts/microsoft-azure/synthesize-speech',
    $151961d6168f89a5$export$720e715da265c262,
  )
}

const $88555a0b04d81c4f$export$2272521fb3bd5353 = async (
  {
    body: {
  ...
  try {
    const textToSpeech = new ($parcel$interopDefault(
      $1hSWc$ibmwatsontexttospeechv1,
    ))({
...
const $88555a0b04d81c4f$export$720e715da265c262 = async (
  {
    body: {
      credentials: { apiKey: apiKey, url: url },
      payload: { text: text, voice: voice },
...
const $78af54c5aebbe2f9$export$ce6d120b07604ec0 = ({ app: app }) => {
  app.post(
    '/api/tts/ibm-watson/list-voices',
    $88555a0b04d81c4f$export$2272521fb3bd5353,
  )
  app.post(
    '/api/tts/ibm-watson/synthesize-speech',
    $88555a0b04d81c4f$export$720e715da265c262,
  )
}

const $bbf043d171ccefaa$export$2272521fb3bd5353 = async (
  {
    body: {
      credentials: { identityPoolId: identityPoolId, region: region },
    },
  },
  res,
) => {
  try {
    const client = new $1hSWc$awssdkclientpolly.Polly({
      region: region,
      credentials:
        $1hSWc$awssdkcredentialprovidercognitoidentity.fromCognitoIdentityPool({
...
const $bbf043d171ccefaa$export$720e715da265c262 = async (
  {
    body: {
      credentials: { identityPoolId: identityPoolId, region: region },
      payload: { text: text, voice: voice },
...
const $100e082905130c51$export$2257b94d0c1621dc = ({ app: app }) => {
  app.post(
    '/api/tts/amazon-polly/list-voices',
    $bbf043d171ccefaa$export$2272521fb3bd5353,
  )
  app.post(
    '/api/tts/amazon-polly/synthesize-speech',
    $bbf043d171ccefaa$export$720e715da265c262,
  )
}
...
const $c5694c718096713d$export$2272521fb3bd5353 = async (_, res) => {
  try {
    const voices = await new Promise((resolve, reject) => {
      $parcel$interopDefault($1hSWc$say).getInstalledVoices(
        (err, apiVoices) => {
...
const $c5694c718096713d$export$720e715da265c262 = async (
  {
    body: {
      payload: { text: text, voice: voice, speed: speed = 1 },
    },
  },
  res,
) => {
  ...
  try {
    ...
    await new Promise((resolve, reject) => {
      $parcel$interopDefault($1hSWc$say).export(
        text,
        voice,
        speed,
        outputFile,
...
const $f2d0c6b74bd4293d$export$68ecd95bc867712b = ({ app: app }) => {
  ...
  app.post(
    '/api/tts/say/list-voices',
    $c5694c718096713d$export$2272521fb3bd5353,
  )
  app.post(
    '/api/tts/say/synthesize-speech',
    $c5694c718096713d$export$720e715da265c262,
  )
}
...
$a3bdc0234368055c$var$app.use(
  $parcel$interopDefault($1hSWc$bodyparser).urlencoded({
    extended: true,
  }),
)
if (process.env.NODE_ENV === 'development')
  $a3bdc0234368055c$var$app.use($parcel$interopDefault($1hSWc$morgan)('dev'))
class $a3bdc0234368055c$var$IzabelaServer {
  ...
  async startApp() {
    this.server = $a3bdc0234368055c$var$app.listen(
      this.getConfig().port,
      () => {
...
const $a3bdc0234368055c$var$izabelaServer =
  new $a3bdc0234368055c$var$IzabelaServer()
var $a3bdc0234368055c$export$2e2bcd8739ae039 =
  $a3bdc0234368055c$var$izabelaServer

const $af5f2ecd477d2761$var$args = process.argv.slice(2)
if ($af5f2ecd477d2761$var$args.includes('--start-server'))
  $a3bdc0234368055c$export$2e2bcd8739ae039.startServer()
