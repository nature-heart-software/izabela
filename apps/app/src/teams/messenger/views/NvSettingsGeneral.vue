        ...
        <NvStack :spacing="5">
          ...
          <NvGroup :spacing="5" align="start" justify="apart" no-wrap>
            <NvStack>
              ...
              <NvText
              >Alternate shortcut if the foreground application is preventing the window from
                showing normally
              </NvText>
            </NvStack>
            <NvKeybinding
          ...
          <NvGroup :spacing="5" align="start" justify="apart" no-wrap>
            <NvStack>
              ...
              <NvText
              >Allow to open a window that doesn't take focus away from the foreground
                application
              </NvText>
              <NvText type="caption"><strong>NOTE:</strong> Keyboard support is limited.</NvText>
            </NvStack>
            <NvSwitch
