  ...
  <NvStack spacing="5">
    ...
    <NvGroup justify="apart" no-wrap spacing="5">
      <NvStack>
        ...
        <NvText>Automatically record and transcribe speech when it is detected </NvText>
        <NvText type="caption">This might affect performance on some devices </NvText>
      </NvStack>
      <NvSwitch
        :modelValue="settingsStore.automaticSpeechDetection"
        class="shrink-0"
        @update:modelValue="(value) => settingsStore.$patch({ automaticSpeechDetection: value })"
      />
    </NvGroup>
    <NvAccessBlocker
      :allowed="settingsStore.automaticSpeechDetection"
      ...
      <NvStack :spacing="5">
        ...
        <NvGroup justify="apart" no-wrap spacing="5">
          ...
          <NvNumberInput
            ...
            @update:modelValue="(value) => settingsStore.$patch({ audioInputSensibility: value })"
          />
        </NvGroup>
        <NvDivider direction="horizontal" />
        <NvGroup justify="apart" no-wrap spacing="5">
        ...
        <NvGroup justify="apart" no-wrap spacing="5">
          ...
          <NvNumberInput
            ...
            @update:modelValue="(value) => settingsStore.$patch({ speechPostrecordTime: value })"
          />
        </NvGroup>
      </NvStack>
    </NvAccessBlocker>
