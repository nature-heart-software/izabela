...
const tailwindTheme = {
  ...
  spacing: Object.fromEntries(
    Object.entries(tokens.spacing).map(([key, value]) => [key, (0, _polished.rem)(value)]),
  ),
  borderRadius: Object.fromEntries(
    Object.entries(tokens.borderRadius).map(([key, value]) => [key, (0, _polished.rem)(value)]),
  ),
  borderWidth: Object.fromEntries(
    Object.entries(tokens.borderWidth).map(([key, value]) => [key, (0, _polished.rem)(value)]),
  ),
  fontSize: Object.fromEntries(
    Object.entries(tokens.fontSize).map(([key, [fontSize, { lineHeight, letterSpacing }]]) => [
      key,
      [
        (0, _polished.rem)(fontSize),
        {
