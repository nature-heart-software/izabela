...
$parcel$export(module.exports, "default", () => $4b54371958711930$export$2e2bcd8739ae039, (v) => $4b54371958711930$export$2e2bcd8739ae039 = v);
...
$parcel$export(module.exports, "default", () => $92e82dbf15e3fc14$export$2e2bcd8739ae039);
...
$92e82dbf15e3fc14$var$app.use(($parcel$interopDefault($bQw3L$bodyparser)).json());
$92e82dbf15e3fc14$var$app.use(($parcel$interopDefault($bQw3L$bodyparser)).urlencoded({
    extended: true
}));
...
class $92e82dbf15e3fc14$var$IzabelaServer {
    ...
    getTempPath() {
        return this.config?.tempPath || ($parcel$interopDefault($bQw3L$path)).resolve('temp');
    }
}
const $92e82dbf15e3fc14$var$izabelaServer = new $92e82dbf15e3fc14$var$IzabelaServer();
var $92e82dbf15e3fc14$export$2e2bcd8739ae039 = $92e82dbf15e3fc14$var$izabelaServer;

});
parcelRequire.register("entDz", function(module, exports) {

$parcel$export(module.exports, "registerGCTTSRoutes", () => $d7f6f10a22a9fcf4$export$776ed06f580210d5);
...
$parcel$export(module.exports, "listVoicesHandler", () => $8cf388cc11f3f529$export$2272521fb3bd5353);
$parcel$export(module.exports, "synthesizeSpeechHandler", () => $8cf388cc11f3f529$export$720e715da265c262);
...
const $8cf388cc11f3f529$export$2272521fb3bd5353 = async ({ body: { apiKey: apiKey  }  }, res, next)=>{
    try {
        const { data: { voices: voices  }  } = await ($parcel$interopDefault($bQw3L$axios)).get(`https://texttospeech.googleapis.com/v1beta1/voices?key=${apiKey}`);
        res.status(200).json(voices);
    } catch (e) {
        $gDEap.handleError(res, "Internal server error", e.message, 500);
    }
};
const $8cf388cc11f3f529$export$720e715da265c262 = async ({ body: { apiKey: apiKey , ...rest }  }, res)=>{
    const outputFile = $bQw3L$path.join($kRHR0.default.getTempPath(), $bQw3L$uuid.v4() + '.mp3');
    try {
        $bQw3L$fs.mkdirSync($bQw3L$path.parse(outputFile).dir, {
            recursive: true
        }, (err)=>{
            if (err) throw err;
        });
        $bQw3L$fs.writeFileSync(outputFile, '');
        const { data: { audioContent: audioContent  }  } = await ($parcel$interopDefault($bQw3L$axios)).post(`https://texttospeech.googleapis.com/v1beta1/text:synthesize?key=${apiKey}`, rest);
        const writeFile = $bQw3L$util.promisify($bQw3L$fs.writeFile);
        await writeFile(outputFile, $8cf388cc11f3f529$require$Buffer.from(audioContent, 'base64'), 'binary');
...
$parcel$export(module.exports, "handleError", () => $759500ea72a9a853$export$d3da1ecaf1206c58);
const $759500ea72a9a853$export$d3da1ecaf1206c58 = (res, reason, message, code)=>{
