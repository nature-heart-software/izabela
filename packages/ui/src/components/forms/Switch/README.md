...
| ----- | --------- | ----- | ---------- | --------------------------------------------------------------- | ------------ | ------------ | ------------------- | ------------------------ | ------- | -------------------------- |
| light | unchecked | rest  | N/A        | track `#ffffff`, thumb `#EBEBEB`                                | `#EBEBEB`    | `1px`        | none                | track `6px`, thumb `4px` | `1`     |                            |
| light | unchecked | hover | N/A        | track `#ffffff`, thumb `#EBEBEB`                                | `#BEBEBE`    | `1px`        | none                | same                     | `1`     | Hover only changes border. |
| light | unchecked | focus | N/A        | track `#ffffff`, thumb `#EBEBEB`                                | `#BEBEBE`    | `1px`        | `0 0 0 4px #F9F9FC` | same                     | `1`     |                            |
| light | checked   | rest  | N/A        | track `#ffffff`, thumb `#0E0E2C`                                | `#EBEBEB`    | `1px`        | none                | same                     | `1`     | Thumb offset `16px`.       |
| dark  | unchecked | rest  | N/A        | track `darken(0.0675, #444444)`, thumb `#626262`                | `#444444`    | `1px`        | none                | same                     | `1`     |                            |
| dark  | unchecked | hover | N/A        | track `darken(0.0675, #444444)`, thumb `#626262`                | `#626262`    | `1px`        | none                | same                     | `1`     |                            |
| dark  | unchecked | focus | N/A        | track `darken(0.0675, #444444)`, thumb `#626262`                | `#626262`    | `1px`        | `0 0 0 4px #444444` | same                     | `1`     |                            |
| dark  | checked   | rest  | N/A        | track `darken(0.0675, #444444)`, thumb `lighten(0.05, #9F9F9F)` | `#444444`    | `1px`        | none                | same                     | `1`     | Thumb offset `16px`.       |
