...
document
  .getElementById('btn-send-main')
  .addEventListener('click', () => sendToWindow('main'))
document
  .getElementById('btn-send-a')
  .addEventListener('click', () => sendToWindow('window-a'))
document
  .getElementById('btn-send-b')
  .addEventListener('click', () => sendToWindow('window-b'))
document
  .getElementById('btn-invoke-main')
  .addEventListener('click', () => invokeToWindow('main'))
document
  .getElementById('btn-invoke-a')
  .addEventListener('click', () => invokeToWindow('window-a'))
document
  .getElementById('btn-invoke-b')
  .addEventListener('click', () => invokeToWindow('window-b'))
